...
export default function InternationalPropertiesPage() {
  ...
  const filteredProperties = useMemo(() => {
    ...
    return properties.filter((property) => {
      const basicInfo = property.overview.basicInfo;
      ...
      const propertyType = getValue(basicInfo, 'property_type') || '';
      ...
      const matchesType =
        selectedType === 'all' ||
        propertyType.toLowerCase().includes(selectedType.toLowerCase());
