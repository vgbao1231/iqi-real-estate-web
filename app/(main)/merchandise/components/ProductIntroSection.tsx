...
const bannerData = [
  {
    ...
    title: 'Áo Thun & Polo IQI',
    subtitle: 'Phong cách hiện đại, chất liệu cao cấp, thoáng mát',
  },
  {
    id: 2,
    image: '/products/banner-2.jpg',
    title: 'Linh Vật IQI',
    subtitle: 'Biểu tượng may mắn, quà tặng ý nghĩa cho mọi dịp',
  },
  {
    id: 3,
    image: '/products/banner-3.jpg',
    title: 'Cốc Ceramic IQI',
    subtitle: 'Thiết kế sang trọng, phù hợp cho cà phê và trà',
  },
];
...
export const ProductIntroSection = () => {
  ...
  return (
    <FadeIn>
      ...
      <div
        id="intro"
        className="relative h-108 py-12 pt-16 overflow-hidden shadow-lg"
      ...
      >
        {bannerData.map((banner: any, index: any) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-black/30 to-black/10" />
          </div>
        ))}
              ...
              <div key={currentSlide} className="space-y-3">
                <FadeIn delay={0.2} y={20}>
                  <h1 className="text-xl md:text-4xl font-bold leading-tight">
                    <span
                      key={currentSlide}
                      className="text-orange-100 text-shadow-md"
                    >
                      {currentBanner.title}
                    </span>
                  </h1>
                ...
                <FadeIn delay={0.3} y={20}>
                  <p
                    ...
                    className="text-sm md:text-lg text-white/90 max-w-2xl mx-auto text-shadow-md leading-relaxed"
                  >
