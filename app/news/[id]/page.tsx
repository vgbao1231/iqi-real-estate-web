...
export default function NewsDetailPage({ params }: { params: { id: string } }) {
  ...
  const article = {
    ...
    content: `
      ...
      <p>Quý 4/2024 chứng kiến sự gia tăng đáng kể về nguồn cung mới với 15 dự án được mở bán, tổng cộng hơn 8,000 căn hộ ra thị trường. Điều này giúp cân bằng cung cầu và ổn định giá cả.</p>
