...
export const Header = ({ filteredProperties }: any) => (
  <FadeIn>
    <div className="bg-gradient-to-r !from-emerald-600 !via-green-600 !to-emerald-700 text-white relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <Badge className="bg-white/20 text-white border-white/30 text-sm px-4 py-2 hover:bg-green-600">
              BẤT ĐỘNG SẢN VIỆT NAM
            </Badge>
          </div>

          <h1 className="text-4xl md:text-5xl font-bold mb-2 leading-tight drop-shadow-md bg-gradient-to-r !from-white !via-emerald-100 !to-white bg-clip-text text-transparent py-2">
            Bất động sản Việt Nam
          </h1>
