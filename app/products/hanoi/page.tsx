...
export default function HanoiPropertiesPage() {
  ...
  const properties = [
    {
      ...
      description:
        'Khu đô thị thông minh đầu tiên tại Hà Nội với công nghệ hiện đại và không gian sống xanh.',
      agent: {
        name: 'Nguyễn Thị Mai',
        phone: '0911 234 567',
    ...
    },
    {
      ...
      description:
        'Khu phức hợp hiện đại tại trung tâm Hà Nội với đầy đủ tiện ích và kết nối thuận lợi.',
      agent: {
        name: 'Trần Văn Hùng',
        phone: '0912 345 678',
        email: 'hung.tran@iqi.com',
        avatar: '/placeholder-2.webp?height=60&width=60',
      },
    },
    {
      ...
      features: ['View Hồ Tây', 'Sky bar', 'Hồ bơi vô cực', 'Spa cao cấp'],
      description:
        'Căn hộ cao cấp với tầm nhìn ra Hồ Tây thơ mộng và tiện ích đẳng cấp 5 sao.',
      agent: {
        name: 'Lê Thị Lan',
        phone: '0913 456 789',
        email: 'lan.le@iqi.com',
        avatar: '/placeholder-2.webp?height=60&width=60',
      },
    },
    {
      ...
      description:
        'Căn hộ hiện đại tại trung tâm Thanh Xuân với vị trí thuận lợi và giá cả hợp lý.',
      agent: {
        name: 'Phạm Minh Đức',
        phone: '0914 567 890',
  ...
  const filteredProperties = properties.filter((property) => {
    ...
    const matchesPrice =
      ...
      (priceRange === '3-4' &&
        Number.parseFloat(property.price.replace(/[^\d.]/g, '')) >= 3 &&
        Number.parseFloat(property.price.replace(/[^\d.]/g, '')) <= 4) ||
      (priceRange === 'over-4' &&
        Number.parseFloat(property.price.replace(/[^\d.]/g, '')) > 4);
          ...
          <FadeIn>
            <div className="text-center">
              ...
              <p className="text-xl opacity-90 mb-8">
                Khám phá những dự án bất động sản tiềm năng tại thủ đô ngàn năm
                văn hiến
              </p>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div className="lg:col-span-2">
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 border-border focus:border-green-400"
                          value={searchTerm}
                    ...
                    <Select value={priceRange} onValueChange={setPriceRange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="3-4">3 - 4 tỷ</SelectItem>
                        <SelectItem value="over-4">Trên 4 tỷ</SelectItem>
                      </SelectContent>
                    </Select>
                    <Select
                      value={propertyType}
                        ...
                        <div className="md:col-span-2 p-6">
                          <div className="space-y-4">
                              ...
                              {property.features
                                ...
                                .map((feature, idx) => (
                                  <Badge
                                    key={idx}
                                    variant="outline"
                                    className="text-xs border-border text-green-700 dark:text-green-300"
                                  >
                                    {feature}
                                  </Badge>
                                ))}
                            ...
                            <div className="flex items-center justify-between pt-2">
                              ...
                              <Link href={`/products/hanoi/${property.id}`}>
          ...
          <div className="space-y-6">
              ...
              <Card className="border-border">
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">46 triệu/m²</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">18 dự án</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Sắp bàn giao:</span>
                    <span className="font-semibold">8 dự án</span>
                  </div>
                </CardContent>
              </Card>
            </SlideIn>
            ...
            <SlideIn direction="right" delay={0.4}>
              <Card className="border-border">
                ...
                <CardContent className="space-y-3">
                  {[
                    { area: 'Tây Hồ', projects: 8, avgPrice: '55 tr/m²' },
                    { area: 'Cầu Giấy', projects: 12, avgPrice: '48 tr/m²' },
                    { area: 'Nam Từ Liêm', projects: 15, avgPrice: '38 tr/m²' },
                    { area: 'Thanh Xuân', projects: 10, avgPrice: '42 tr/m²' },
                  ].map((area, index) => (
                    <div
                      key={index}
