    ...
    amenities: [
      {
        ...
        items: ['Hồ bơi vô cực', 'Gym hiện đại', 'Tennis court', 'Yoga studio'],
      },
      {
        category: 'Tiện ích gia đình',
        items: ['Khu vui chơi trẻ em', 'BBQ area', 'Function room', 'Library'],
      },
      {
        category: 'Dịch vụ',
        items: [
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            ...
                            <span className="font-bold text-blue-600">
                              {property.investment.capitalGrowth}
                            </span>
                          </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              {property.investment.paymentPlan}
                            </p>
                          </div>
                          <div>
                            <h4 className="font-semibold mb-2">
