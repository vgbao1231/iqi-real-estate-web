...
export default function Location({ property }: any) {
  return (
    <section id="location" className="max-w-7xl mx-auto px-4 space-y-8">
        ...
        {property.locationHighlights.map((highlight: any, index: any) => {
          ...
          return (
            <motion.div
              ...
              className="p-5 bg-card rounded-lg border-l-4 border-blue-500"
            >
