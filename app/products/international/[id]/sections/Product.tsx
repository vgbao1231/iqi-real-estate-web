...
const Product = forwardRef<HTMLElement, { property: any }>(
  ({ property }, ref) => {
    return (
      <section
        ref={ref}
        id="products"
        className="max-w-7xl mx-auto px-4 space-y-12 py-16"
      >
        <h3 className="text-3xl font-bold mb-4 center-both text-orange-600">
