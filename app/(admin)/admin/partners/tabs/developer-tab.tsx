    ...
    data.sort((a, b) => {
      ...
      switch (filters.sortBy) {
        ...
        case 'projects':
          ...
          break;
        case 'revenue':
          // Convert revenue to number for sorting (remove text and convert)
          aValue = parseFloat(a.revenue.replace(/[^\d.]/g, ''));
          bValue = parseFloat(b.revenue.replace(/[^\d.]/g, ''));
          break;
        case 'partnership':
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader className="border-b border-gray-100">
          ...
          <CardDescription className="text-gray-600">
            Quản lý thông tin các chủ đầu tư bất động sản
          </CardDescription>
        </CardHeader>
