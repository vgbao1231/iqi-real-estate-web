...
import { ArrowLeft, Users, Award, Globe, Target, Shield, Zap, TrendingUp } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/20">
        <div className="container mx-auto px-4">
          <FadeIn>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Giới thiệu về IQI Vietnam</h1>
            <p className="text-xl text-muted-foreground max-w-3xl">
              Với hơn 15 năm kinh nghiệm trong lĩnh vực bất động sản, IQI Vietnam đã khẳng định vị thế là đối tác tin
              cậy của hàng nghìn khách hàng trên toàn quốc.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <SlideIn direction="left">
              <div>
                <h2 className="text-3xl font-bold mb-6">Câu chuyện thành lập</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    IQI Vietnam được thành lập vào năm 2009 với tầm nhìn trở thành công ty bất động sản hàng đầu tại
                    Việt Nam. Khởi đầu từ một văn phòng nhỏ tại TP.HCM, chúng tôi đã không ngừng phát triển và mở rộng.
                  </p>
                  <p>
                    Năm 2015, IQI Vietnam chính thức gia nhập mạng lưới Juwai IQI - tập đoàn bất động sản lớn nhất Đông
                    Nam Á, mở ra cơ hội tiếp cận thị trường quốc tế cho khách hàng Việt Nam.
                  </p>
                  <p>
                    Đến nay, với hơn 500 đại lý chuyên nghiệp và 20 văn phòng trên toàn quốc, chúng tôi tự hào là cầu
                    nối tin cậy giữa khách hàng và những cơ hội đầu tư bất động sản tốt nhất.
                  </p>
                </div>
              </div>
            </SlideIn>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Sứ mệnh - Tầm nhìn - Giá trị</h2>
          </FadeIn>
                ...
                <Card className="text-center h-full">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Kết nối khách hàng với những cơ hội bất động sản tốt nhất, tạo ra giá trị bền vững cho cộng đồng
                      và xã hội thông qua dịch vụ chuyên nghiệp và tận tâm.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                ...
                <Card className="text-center h-full">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      ...
                      mở rộng ra thị trường khu vực và quốc tế.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
            ...
            <ScaleIn delay={0.6}>
              <motion.div whileHover={{ y: -10 }}>
                <Card className="text-center h-full">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Chính trực, chuyên nghiệp, tận tâm và luôn đặt lợi ích khách hàng lên hàng đầu. Chúng tôi cam kết
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Thành tựu đạt được</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Những con số ấn tượng khẳng định vị thế của IQI Vietnam trong ngành bất động sản
            </p>
          </FadeIn>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Những con người tài năng và giàu kinh nghiệm dẫn dắt IQI Vietnam phát triển
            </p>
          </FadeIn>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Muốn tìm hiểu thêm về IQI Vietnam?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Liên hệ với chúng tôi để được tư vấn chi tiết về các dịch vụ và cơ hội hợp tác
            </p>
