...
import { ArrowLeft, Phone, Mail, MapPin, Clock, MessageCircle, Send, Building, Headphones, Globe } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-950/20 dark:to-green-900/20">
        <div className="container mx-auto px-4">
          <FadeIn>
            ...
            <Badge className="mb-4 bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300">LIÊN HỆ</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Liên hệ với IQI Vietnam</h1>
            <p className="text-xl text-muted-foreground max-w-3xl">
              Chúng tôi luôn sẵn sàng hỗ trợ bạn 24/7. Liên hệ ngay để được tư vấn miễn phí từ đội ngũ chuyên gia
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Liên hệ nhanh</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Chọn cách thức liên hệ phù hợp với bạn</p>
          </FadeIn>
              ...
              <ScaleIn key={index} delay={index * 0.2}>
                <motion.div whileHover={{ y: -10 }}>
                  <Card className="text-center h-full">
                    ...
                    <CardContent>
                      <div className="text-lg font-bold mb-4">{method.contact}</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {quickActions.map((action, index) => (
                <motion.div key={index} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" className={`${action.color} text-white`} onClick={action.action}>
            ...
            <FadeIn>
              <Card>
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">Điền form bên dưới và chúng tôi sẽ phản hồi trong vòng 24h</p>
                </CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Công ty bất động sản hàng đầu Việt Nam với hơn 15 năm kinh nghiệm
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="mt-4 p-3 bg-green-100 dark:bg-green-900/30 rounded-lg">
                        <div className="flex items-center text-green-700 dark:text-green-300">
                          ...
                          <span className="font-semibold">Hotline 24/7: 1900 1234</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <FadeIn className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Văn phòng của chúng tôi</h2>
                ...
                <motion.div whileHover={{ y: -5 }}>
                  <Card className="h-full">
                    ...
                    <CardContent className="p-6">
                      <CardTitle className="text-xl mb-4">{office.city}</CardTitle>
