    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <FadeIn>
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              IQI Vietnam tự hào hợp tác với những thương hiệu uy tín hàng đầu
              trong và ngoài nước, mang đến cho khách hàng những sản phẩm và
              dịch vụ tốt nhất.
            </p>
          </FadeIn>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-4 space-x-2">
              {Array.from({
                length: Math.ceil(developerPartners.length / 3),
              }).map((_, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-gray-600 to-gray-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Muốn trở thành đối tác của IQI Vietnam?
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Gia nhập mạng lưới đối tác của chúng tôi để cùng phát triển và
              thành công trong thị trường bất động sản
            </p>
