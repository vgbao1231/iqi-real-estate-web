...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <Button variant="outline" size="icon" className="hover:bg-orange-100 dark:hover:bg-orange-900/20 bg-transparent">
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="icon"
          className="hover:bg-orange-100 dark:hover:bg-orange-900/20 bg-transparent border-muted-foreground/20"
        >
